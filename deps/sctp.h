/// taken from /usr/src/kernels/2.6.32-573.18.1.el6.x86_64/include/linux/sctp.h
 ...
 */
typedef enum {
	SCTP_PARAM_ACTION_DISCARD     = 0x0000,
	SCTP_PARAM_ACTION_DISCARD_ERR = 0x4000,
	SCTP_PARAM_ACTION_SKIP        = 0x8000,
	SCTP_PARAM_ACTION_SKIP_ERR    = 0xc000,
} sctp_param_action_t;

enum { SCTP_PARAM_ACTION_MASK = 0xc000, };
